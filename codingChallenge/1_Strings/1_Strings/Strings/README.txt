...
4. Call each of the provided methods with the correct arguments, according to the instruction in the XML comments above the 
    ...
    Console.WriteLine() to give instructions
    Console.ReadLine() to get user input that you can send to the methods.
    You will need to convert the string returned from Console.ReadLine() to an integer to send it to methods.

    
    // To get userinfo and return to user
    int varName Console.ReadLine();
